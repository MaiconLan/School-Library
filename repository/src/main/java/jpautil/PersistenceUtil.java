...
public final class PersistenceUtil {
	private static final String UNIT_NAME = "SysPet";
	...
	private static synchronized void loadInstance() {
		if (FACTORY == null) {
			try {
				...
				FileInputStream fis = new FileInputStream(System.getenv("homepath") + "/syspet/servidor.properties");
				properties.load(fis);

				String ip = "jdbc:postgresql://" + properties.getProperty("IP_SERVIDOR") + ":5432/syspet";
